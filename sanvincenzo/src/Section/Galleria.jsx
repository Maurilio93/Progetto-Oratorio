...
export function Galleria() {
    ...
    return (
        <>
            <Helmet>
                <title>Galleria | Oratorio San Vincenzo</title>
                <meta name="description" content="Esplora la galleria fotografica dell'Oratorio San Vincenzo con i momenti più belli delle nostre attività sportive e comunitarie." />
                <meta name="keywords" content="galleria, foto, Oratorio San Vincenzo, eventi, sport, comunità" />
            </Helmet>
            <h1 className="sr-only">Galleria Fotografica</h1>
