    ...
    <div className="bg-white">
      <header className="bg-blue-400 fixed top-0 left-0 right-0 z-50">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between h-16 px-4 md:px-0">
          ...
          <div className="hidden md:flex items-center md:mx-4 lg:mx-10">
              ...
              <ul className="flex gap-6 text-sm">
                ...
                >
                  ...
                  {isSocietaDropdownOpen && (
                    <div className="absolute z-10 bg-white font-bold divide-y divide-gray-100 rounded-lg shadow w-44 max-w-full left-1/2 transform -translate-x-1/2 mt-2">
