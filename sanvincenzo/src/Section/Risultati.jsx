...
export function Risultati() {
    ...
    return (
        <>
            <Helmet>
                <title>Risultati | Oratorio San Vincenzo</title>
                <meta name="description" content="Consulta i risultati delle partite delle squadre dell'Oratorio San Vincenzo, aggiornati in tempo reale." />
                <meta name="keywords" content="risultati, partite, Oratorio San Vincenzo, calcio, squadre" />
            </Helmet>
            <h1 className="sr-only">Risultati</h1>
