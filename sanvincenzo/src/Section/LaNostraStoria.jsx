...
export function LaNostraStoria() {
  ...
  return (
    <>
      <Helmet>
        <title>La Nostra Storia | Oratorio San Vincenzo</title>
        <meta name="description" content="Scopri la storia dell'Oratorio San Vincenzo: i nostri valori, la missione e come siamo cresciuti nel tempo." />
        <meta name="keywords" content="storia, Oratorio San Vincenzo, missione, valori, comunità" />
      </Helmet>
      <h1 className="sr-only">La Nostra Storia</h1>
      <div className="relative bg-white p-8 md:p-16">
        ...
        <div className="flex items-center justify-center mt-10 mb-4 md:mt-6">
          <h2 className="text-l -mx-8 md:text-2xl font-semibold text-blue-400 py-1 ml-8 px-6 mr-2">
            LA NOSTRA STORIA
          </h2>
          <img
